    ...
    // border={"1px solid blue"}
      ...
      //  border={"1px solid blue"}
        ...
        // border={"1px solid blue"}
         ...
         <CheckboxGroup colorScheme='green' >
            <Grid  direction={['row', 'row']} >
              <Checkbox value='Hammer'
               onChange={handleBrandOnChange}
               checked={brand.includes("Hammer")}
              >
                <Text> Hammer </Text>
               
                </Checkbox>

                <Checkbox value='Fire-Boltt'
               onChange={handleBrandOnChange}
               checked={brand.includes("Fire-Boltt")}
              >
                <Text> Fire-Boltt </Text>
